<footer class="bg-black text-gray-300 pt-16 pb-6">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-2 text-white font-black text-xl tracking-wider">
                    <!-- <i class="fa-solid fa-graduation-cap text-[#e91e63] text-2xl"></i> -->
                    <img src="/skillflow/assets/images/image.png" alt="eduFuture Logo" class="w-20 h-20 object-contain block">
                    <span>SkillFlow IT<span class="text-[#e91e63]">Institute</span></span>
                </div>
                <p class="text-sm text-gray-400 leading-relaxed font-medium">
                    স্মার্ট বাংলাদেশ বিনির্মাণে দক্ষতা অর্জনের মাধ্যমে নিজেকে যোগ্য করার অন্যতম শ্রেষ্ঠ অনলাইন ও অফলাইন
                    ট্রেনিং ইনস্টিটিউট সবুজ একাডেমি।
                </p>
            ...
            <div class="space-y-4">
                <h3 class="text-white font-bold text-lg tracking-wide border-b border-gray-800 pb-2">
                    যোগাযোগ
                </h3>
        ...
        <div class="border-t border-gray-900 pt-6 text-center">
            <p class="text-xs text-gray-500 font-semibold tracking-wide">
                Copyright © 2026 <span class="text-gray-400">SkillFlow IT Institute</span>. All rights reserved.
            </p>
        </div>
