...
<header
        ...
        <div class="max-w-6xl mx-auto h-full flex justify-between items-center">
            ...
            <div class="flex items-center gap-7">
                <div class="flex items-center gap-4.5">
                    <a href="https://www.facebook.com/skillflowit" target="_blank"
                        class="w-7.5 h-7.5 bg-white text-[#00bcd4] rounded-full flex items-center justify-center text-sm transition-all duration-300 hover:bg-[#1877F2] hover:text-white hover:scale-110">
                        <i class="fa-brands fa-facebook-f"></i>
                    </a>
                    <a href="#"
                        class="w-6.5 h-6.5 bg-white text-[#00bcd4] rounded-full flex items-center justify-center text-[11px] transition-all duration-300 hover:bg-[#FF0000] hover:text-white hover:scale-110">
                        <i class="fa-brands fa-youtube"></i>
                    </a>
                    <a href="#"
                        class="w-6.5 h-6.5 bg-white text-[#00bcd4] rounded-full flex items-center justify-center text-[11px] transition-all duration-300 hover:bg-[#0077B5] hover:text-white hover:scale-110">
                        <i class="fa-brands fa-linkedin-in"></i>
                    </a>
                    <a href="#"
                        class="w-6.5 h-6.5 bg-white text-[#00bcd4] rounded-full flex items-center justify-center text-[11px] transition-all duration-300 hover:bg-[#E1306C] hover:text-white hover:scale-110">
    ...
    <div class="bg-white h-[64px] px-12 md:px-20">
        <div class="max-w-6xl mx-auto h-full flex justify-between items-center gap-8">

            <a href="/skillflow/index.php" class="flex items-center gap-2 shrink-0 select-none"
                style="font-family: 'Inter', sans-serif;">
                <img src="/skillflow/assets/images/image.png" alt="Logo" class="w-20 h-20 object-contain block">

                <div class="flex flex-col leading-none ml-0.5">
                    <span class="text-gray-900 text-lg font-black tracking-wide">SkillFlow</span>
                    <span class="text-[9px] font-bold text-gray-400 tracking-[0.25em] mt-0.5">IT Institute</span>
                </div>
            </a>
